				...
				{(orders ?? []).length === 0 ? (
					...
					<div className="space-y-6 sm:space-y-8">
						{orders?.map((order) => (
							...
							className="bg-white border vorder-gray-200 rounded-lg shadow-sm overflow-hidden"
							>
							...
							>
								<div className="flex items-center gap-3 sm:gap-4">
									{product.product?.image && (
										<div className="relative h-14 w-14 sm:h-16 sm:w-16 flex-shtink-0 rounded-md overflow-hidden">
											<Image 
